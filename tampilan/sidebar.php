      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="sertifikat.php"><i class="fas fa-envelope"></i> <span>SERTIFIKAT</span></a></li>
              <li><a class="nav-link" href="events.php"><i class="fas fa-database"></i> <span>EVENTS</span></a></li>
              ...
              <li><a class="nav-link" href="generate.php"><i class="fas fa-book"></i> <span>GENERATE</span></a></li>
              <li><a class="nav-link" href="view_certificate.php"><i class="fas fa-book"></i> <span>VIEW</span></a></li>
        </aside>
      </div>
<?php 
}
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              <ul class="sidebar-menu">
              <li class="menu-header">Fitur</li>
              <li><a class="nav-link" href="history.php"><i class="fas fa-fire"></i> <span>GENERATE</span></a></li>
        </aside>
      </div>
     <?php
   }
