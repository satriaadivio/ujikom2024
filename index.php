        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="img/avatar/10234.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
              ...
              <div class="card-body">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <p class="login-register-text">belum punya akun? <a href="register.php">registrasi</a></p>
                  </div>
                </form>
